    ...
    <section class="pt-24 pb-8 bg-light">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="relative rounded-3xl shadow-2xl overflow-hidden mb-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
                ...
                <div class="lg:col-span-2">
                    <div class="card rounded-3xl shadow-2xl p-8 md:p-12 mb-8">
                        ...
                        <h3 class="text-2xl font-bold text-primary mb-4 mt-8">Key Features</h3>
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check-circle text-secondary mt-1 flex-shrink-0"></i>
                                <p>High-efficiency reverse osmosis membranes with 99% rejection rate</p>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check-circle text-secondary mt-1 flex-shrink-0"></i>
                                <p>Automated control system with real-time monitoring</p>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check-circle text-secondary mt-1 flex-shrink-0"></i>
                                <p>Energy recovery system reducing power consumption by 40%</p>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check-circle text-secondary mt-1 flex-shrink-0"></i>
                                <p>Pre-treatment system including multimedia filters and carbon filters</p>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check-circle text-secondary mt-1 flex-shrink-0"></i>
                                <p>Chemical dosing system for optimal performance</p>
                            </li>
                            <li class="flex items-start gap-3">
                                <i class="fas fa-check-circle text-secondary mt-1 flex-shrink-0"></i>
                                <p>Comprehensive safety features and redundancy systems</p>
                            </li>
                        </ul>

                        <h3 class="text-2xl font-bold text-primary mb-4 mt-6">Scope of Work</h3>
                        <p class="leading-relaxed mb-3">
                            The project scope encompassed the following phases:
                        </p>
                        <ol class="list-decimal list-inside space-y-3 mb-6 text-gray-500">
                    ...
                    <div class="card rounded-3xl shadow-2xl p-8 md:p-12">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&h=400&fit=crop" 
                                 alt="Gallery 1" 
                                 class="w-full h-48 object-cover rounded-xl shadow-lg hover:scale-105">
    ...
    <section class="py-38 bg-white">
        <div class="container mx-auto px-4 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto">
                <a href="#" class="card project-card rounded-3xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col fade-in-up" data-delay="0">
